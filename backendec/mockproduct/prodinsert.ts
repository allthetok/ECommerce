...
const ultraBoost22 = {
	...
	"price": 175,
	"description": "Even on your busiest days, running is a priority. These adidas trainers make every mile count, thanks to the incredible energy return of BOOST cushioning. The Linear Energy Push system increases stability for a smooth and steady stride, and the Stretchweb outsole delivers natural flex to keep you moving comfortably, no matter your distance or pace.",
	"sizes": [
		{
			"color": "Core Black / Core Black / Core Black",
			"sizes": [
...
const superStarGore = {
	...
	"price": 180,
	"description": "Whether the day brings rain or snow, these adidas Superstar sneakers have you covered. A GORE-TEX membrane provides breathable protection from the elements without sacrificing the classic style these shoes are known for. First hitting the court in 1970, the Superstar has spent decades exploring street culture. A fresh nubuck upper keeps this iconic shell-toe shoe ready for modern times. Waterproof and windproof, they will keep your feet comfortable and your stride going strong no matter whats on the agenda outside.",
	"sizes": [
		{
			"color": "Core Black / Core Black / Cloud White",
			"sizes": [
...
const stanSmithBape = {
	...
	"price": 160,
	"description": "Sporting an immaculate Cloud White and Core Black, these renditions of the Stan Smith are an ode to understated sophistication with bursts of signature BAPE flair. The shoe's leather upper boasts an embossed BAPE camo print, offering a subtle nod to the brands heritage. The heel tab proudly showcases BAPEs vibrant camo, contrasting the subtle detail. Glistening touches of metallic gold adorn the shoe, from the midfoots Stan Smith inscription to the special 30th Anniversary BAPE lace dubrae. The iconic Stan Smith portrait on the tongue tag is replaced with BAPEs unmistakable APE logo, bathed in the same luxe gold. Complementary golden BAPE branding graces the heel tab and insole, while a rich creamy midsole and outsole seal the designs elegance.",
	"sizes": [
		{
			"color": "Core Black/Core Black/Gold Metallic",
			"sizes": [
...
const NMDR1 = {
	...
	"price": 200,
	"description": "Pack your bag, lace up and get going. City adventures beckon in these NMD_R1 shoes. An update to an acclaimed 80s runner from the adidas archive, these modern sneakers have a soft, stretchy knit upper and energy-returning Boost cushioning for all-day comfort. Bold color and signature midsole plugs make a statement, so wherever you're headed, you're sure to show up in style. This product is made with a yarn that features 50% recycled polyester and 50% Parley Ocean Plastic — plastic waste which we intercepted from remote islands, beaches, coastal communities and shorelines in order to prevent it from polluting our oceans. In total, this product has 20% recycled content.",
	"sizes": [
		{
			"color": "Core Black / Core Black / Core Black",
			"sizes": [
...
const NMDR2 = {
	...
	"price": 190,
	"description": "Head into the future with confidence. Not to mention style. Inspired by running silhouettes from the 80s archive, NMD was born in 2015 to merge sleek style with modern technologies and comfort. These juniors adidas NMD_R1 V2 shoes keep your feet cushioned with a responsive BOOST midsole. Chic transparent overlays add a cyberpunk vibe. The future is yours. Go and get it. This shoes upper is made with a high-performance yarn which contains at least 50% Parley Ocean Plastic — reimagined plastic waste, intercepted on remote islands, beaches, coastal communities and shorelines, preventing it from polluting our ocean. The other 50% of the yarn is recycled polyester.",
	"sizes": [
		{
			"color": "Cloud White / Core Black / Cloud White",
			"sizes": [
...
const NikeAF1Base = {
	...
	"price": 90,
	"description": "Air Force 1s have come a long way since their debut as the first on-court shoe to feature Nike Air technology. But despite this, the cultural icon stays true to its roots with the same soft and springy cushioning that changed sneaker history. This sneaker-head favourite delivers lasting comfort, while its padded ankle and tongue make for a soft ride. The rubber sole features the iconic circular pattern for durable	traction. Originally designed for performance hoops, Nike Air cushioning adds lightweight, all-day comfort.",
	"sizes": [
		{
			"color": "White/White/White",
			"sizes": [
...
const NikeAirMax97Base = {
	...
	"price": 160,
	"description": "Inspired by nature, the Air Max 97 ushered in a new era in footwear for a modern world. The silhouette was introduced with a full-length Air unit all around the midsole for maximum comfort for both runners and everyday wear. Like the 95, it maintained its layered look, but the 3M detail was what sealed the deal. Browse our selection of AM97, including the latest releases.",
	"sizes": [
		{
			"color": "White/White/White",
			"sizes": [
...
const AJ1Low = {
	...
	"price": 115,
	"description": "Inspired by the original that debuted in 1985, the Air Jordan 1 Low offers a clean, classic look thats familiar yet always fresh. With an iconic design that pairs perfectly with any fit, these kicks ensure youll always be on point.",
	"sizes": [
		{
			"color": "Black/White/Yellow Ochre",
			"sizes": [
...
const AJ4Base = {
	...
	"price": 300,
	"description": "The Air Jordan 4 is a classic sneaker in the Air Jordan line. It was released in 1989 and designed by Nike designer Tinker Hatfield, paying homage to the original Air Jordan design while introducing new colorways and design features. The sneaker is known for its distinctive design, with visible Air unit technology and top-quality leather construction. The Air Jordan 4 was created to offer superior comfort, durability, and style to come up with an extraordinary product. In our opinion, one of the most notable features of the Air Jordan 4 is the “Wings” on the side of the shoe, which represent Michael Jordans soaring abilities on the basketball court. The shoes also feature a unique lacing system with plastic Wing eyelets, which provide added support and durability. Over the years, the Air Jordan 4 has been released in a range of colors and collaborations, including the Jordan 4 Retro Undefeated (2018 Sample), which was released as part of a collaboration between Nike and LA-based streetwear brand Undefeated. These collaborations and limited-edition releases have only added to the sneakers popularity. The brand comprises a range of other products, including clothing and accessories. The line includes t-shirts, hoodies, shorts, and hats, among other items. The Air Jordan 4 works best with other products in the Air Jordan. The brands clothing and accessories are compatible with the shoes style and design. A perfect example of this is the Air Jordan Hoodie, which perfectly complements the style and design of the Air Jordan 4.",
	"sizes": [
		{
			"color": "White/Fire Red/Black/Neutral Grey",
			"sizes": [
...
const AJ5Base = {
	...
	"price": 275,
	"description": "The Air Jordan 5 hit shelves in 1990. It maintained the mesh side panels with its predecessor and took another bold step with its look—it included the first appearance of a translucent sole on a Jordan signature sneaker. Tinker Hatfield drew inspiration from World War II era fighter planes when he implemented the infamous shark-teeth look into the sneakers design along the midsole. The AJ5 was first brought back in 2000, with great retro colorways arriving including the UNC, A Ma Maniere Dawn and A Ma Maniere Dusk releases.",
	"sizes": [
		{
			"color": "University Blue/Black/White",
			"sizes": [
...
const NB2002RBase = {
	...
	"price": 180,
	"description": "Launched in 2010, New Balances 2002R silhouette experienced a cultural rediscovery in the 2020s as dad shoes continued to exert influence across the footwear landscape. Rooted in performance running, the mixed-material upper comprises leather, suede and mesh, with an ABZORB midsole and N-ergy outsole underfoot. Discover the New Balance 2002R, featuring styles created in collaboration with Salehe Bembury, Joe Freshgoods, atmos, JJJJound and more.",
	"sizes": [
		{
			"color": "Taupe/Angora/Silver Metallic",
			"sizes": [
...
const NB530Base = {
	...
	"price": 160,
	"description": "The 530 mens sneaker is a throwback of one of our classic running shoes. This casual kick combines everyday style with modern tech. ABZORB cushioning underfoot adds superior comfort. Put a retro spin on your step with the 530 mens sneaker.",
	"sizes": [
		{
			"color": "Moonbeam/Sea Salt/White",
			"sizes": [
...
const NB5740Base = {
	...
	"price": 120,
	"description": "In 2021, New Balance debuted the 57/40, building on the iconic styling of the 574 silhouette. Exaggerated “N” logos and reflective accents adorn the suede uppers, with an undulating, stacked foam midsole incorporated as a nod to the brands 90s heritage. From Au Lait to Sea Salt, explore a selection of New Balance 57/40 sneakers.",
	"sizes": [
		{
			"color": "White/Sea Salt/Silver Metallic",
			"sizes": [
